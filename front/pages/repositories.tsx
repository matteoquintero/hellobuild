...
const Repositories: NextPage = () => {
  return (
    ...
    <div className='h-full bg-hello-blue-dark'>
        <Head>
            <title>Repositories - Hellobuild</title>
            <meta name="description" content="Repositories hellobuild" />
            <link rel="icon" href="/favicon.png" />
        </Head>
        <NavBar></NavBar>
        <main>
        <div className="flex items-center justify-center w-full py-8">
            <div className="max-w-2xl py-6 pl-6 pr-12 bg-white rounded shadow dark:bg-hello-black">
                <div className="flex items-center">
                    <p className="text-lg font-semibold leading-4 text-gray-800 md:pr-96 dark:text-gray-100">Statistics</p>
                    <p className="pl-6 text-xs leading-3 text-right text-gray-500 dark:text-gray-400">Updated 1 month ago</p>
                </div>
                <div className="items-center justify-between pt-8 md:flex">
                    <div className="flex items-center">
                        ...
                        <div className="pl-4">
                            <p className="text-lg font-semibold leading-none text-gray-800 w-11 dark:text-gray-100">230k</p>
                            <p className="w-8 pt-2 text-xs leading-3 text-gray-500 dark:text-gray-400">Sales</p>
                        </div>
                    </div>
                    <div className="flex items-center pt-4 md:pt-0 md:pl-10">
                        ...
                        <div className="pl-4">
                            <p className="text-lg font-semibold leading-none text-gray-800 w-11 dark:text-gray-100">8.549k</p>
                            <p className="w-8 pt-2 text-xs leading-3 text-gray-500 dark:text-gray-400">Customers</p>
                        </div>
                    </div>
                    <div className="flex items-center pt-4 md:pt-0 md:pl-10">
                        ...
                        <div className="pl-4">
                            <p className="text-lg font-semibold leading-none text-gray-800 w-11 dark:text-gray-100">1.423k</p>
                            <p className="w-8 pt-2 text-xs leading-3 text-gray-500 dark:text-gray-400">Products</p>
                        </div>
                    </div>
                    <div className="flex items-center pt-4 md:pt-0 md:pl-10">
                        ...
                        <div className="pl-4">
                            <p className="text-lg font-semibold leading-none text-gray-800 w-11 dark:text-gray-100">$9745</p>
                            <p className="w-8 pt-2 text-xs leading-3 text-gray-500 dark:text-gray-400">Revenue</p>
                        </div>
                    </div>
                </div>
